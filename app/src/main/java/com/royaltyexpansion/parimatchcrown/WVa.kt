...
import com.royaltyexpansion.parimatchcrown.Constants.Campaign2
import com.royaltyexpansion.parimatchcrown.Constants.Campaign3
import java.io.File
...
class WVa : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        view1 = findViewById(R.id.PCview)
    ...
    private fun getUrl(): String {
        ...
        val pack = "com.royaltyexpansion.parimatchcrown"
        ...
        val first = "https://"
        val second = "parimatchcrown.space/6M3tw"
